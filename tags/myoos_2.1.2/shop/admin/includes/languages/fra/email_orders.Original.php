...
define('EMAIL_TEXT_STATUS_UPDATE', 'L\'état de votre commande a été changé.' . "\n\n" . 'Nouveau état: %s' . "\n\n" . 'Si vous avez des questions concernant votre commande répondez s.v.p. à cet e-mail.' . "\n\n" . 'Meilleures salutations' . "\n");
define('EMAIL_TEXT_COMMENTS_UPDATE', 'Remarque et commentaire à votre commande:' . "\n\n%s\n\n");
