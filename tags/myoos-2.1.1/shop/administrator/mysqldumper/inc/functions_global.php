...
function ReadStatusline($line)
{
	/*AUFBAU der Statuszeile:
		-- Status:tabellenzahl:datens�tze:Multipart:Datenbankname:script:scriptversion:Kommentar:MySQLVersion:Backupflags:SQLBefore:SQLAfter:EXTINFO
...
function ErrorReport()
{
	...
	$r.='<tr class="'.(($i++ % 2) ? 'dbrow' : 'dbrow1').'"><td valign="top">zus�tzliche Bemerkungen</td><td><textarea name="error_zusatz" cols="30" rows="6"></textarea></td></tr>'."\n";
