...
$aLang['text_see_orders'] = 'U kan uw bestelling(en) op pagina <a href="' . oos_href_link($aPages['account'], 'SSL') . '"><u>\'Uw rekening\'</a></u> ieder moment bekijken en daar ook uw <a href="' . oos_href_link($aPages['account_history'], 'SSL') . '"><u>\'Besteloverzicht\'</u></a> bekijken.';
$aLang['text_contact_store_owner'] = 'Indien u vragen met betrekking tot uw bestelling heeft, richt u zich dan aan onze <a href="' . oos_href_link($aPages['contact_us']) . '"><u>Bedrijf</u></a>.';
