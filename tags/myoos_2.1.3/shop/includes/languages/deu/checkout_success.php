...
$aLang['text_see_orders'] = 'Sie k&ouml;nnen Ihre Bestellung(en) auf der Seite <a href="' . oos_href_link($aPages['account'], '', 'SSL') . '"><u>\'Ihr Konto\'</a></u> jederzeit einsehen und sich dort auch Ihre <a href="' . oos_href_link($aPages['account_history'], '', 'SSL') . '"><u>\'Bestell&uuml;bersicht\'</u></a> anzeigen lassen.';
$aLang['text_contact_store_owner'] = 'Falls Sie Fragen bez&uuml;glich Ihrer Bestellung haben, wenden Sie sich an unseren <a href="' . oos_href_link($aPages['contact_us']) . '"><u>Vertrieb</u></a>.';
