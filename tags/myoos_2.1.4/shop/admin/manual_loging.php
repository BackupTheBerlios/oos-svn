...
if ( !current_user_can('manual_loging') )
...
<?php
      ...
      if ($login['status'] != '0') {
        $email_address = "";
?>
       <tr><td width="100%" align="center"><br /><?php echo oos_draw_login_form('login', $aCatalogPage['login_admin'], 'action=login_admin','POST', 'target=_blank'); ?>
