...
Plugin URI: http://blog.jongbelegen.net/piwik-analytics
...
Version: 0.9.2
Author URI: http://blog.jongbelegen.net/
License: GPL
					...
					<tr>
						...
						<td>
							...
							<div id="expl3" style="display:none;">
								<h3>Explanation</h3>
								<p>Example: www.yourdomain.com -- Leave blank (default) if this is the same as your blog.</p>
							</div>
						</td>
					</tr>
					<tr>
