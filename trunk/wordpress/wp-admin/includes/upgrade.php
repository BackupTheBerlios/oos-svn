...
function wp_install_defaults($user_id) {
	...
	$default_links = array();
	$default_links[] = array(	'link_url' => 'http://doku.wordpress-deutschland.org/',
								'link_name' => 'Dokumentation',
								'link_rss' => '',
								'link_notes' => '');

	$default_links[] = array(	'link_url' => 'http://blog.wordpress-deutschland.org/',
								'link_name' => 'News-Blog',
								'link_rss' => 'http://blog.wordpress-deutschland.org/feed/',
								'link_notes' => '');

	$default_links[] = array(	'link_url' => 'http://faq.wordpress-deutschland.org/',
								'link_name' => 'FAQ',
								'link_rss' => '',
								'link_notes' =>'');
	...
	$default_links[] = array(	'link_url' => 'http://themes.wordpress-deutschland.org/',
								'link_name' => 'Themepool',
								'link_rss' => '',
								'link_notes' =>'');

	$default_links[] = array(	'link_url' => 'http://planet.wordpress-deutschland.org/',
