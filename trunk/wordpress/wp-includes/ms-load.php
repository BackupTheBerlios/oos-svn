...
function wpmu_current_site() {
	...
	if ( 1 == count( $sites ) )
		...
		wp_die( /*WP_I18N_NO_SITE_DEFINED*/'Es wurde kein Blog definiert. Wenn du der Besitzer dieser Website bist, lese bitte <a href="http://codex.wordpress.org/Debugging_WPMU">Debugging WPMU (engl.)</a> f&uuml; weitere Informationen.'/*/WP_I18N_NO_SITE_DEFINED*/ );
}
