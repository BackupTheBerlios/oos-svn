...
if ( version_compare( '4.3', phpversion(), '>' ) ) {
	die( sprintf( /*WP_I18N_OLD_PHP*/'Der Server l&auml;uft mit der PHP-Version %s - WordPress ben&ouml;tigt aber mindestens Version 4.3.'/*/WP_I18N_OLD_PHP*/, phpversion() ) );
}
...
<body>
	<h1>Die Seite ist ganz kurz nicht erreichbar. In einer Minute sollte wieder alles klappen.</h1>
</body>
</html>
<?php
		die();
...
if ( !extension_loaded('mysql') && !file_exists(WP_CONTENT_DIR . '/db.php') )
	die( /*WP_I18N_OLD_MYSQL*/'Die PHP-Installation scheint nicht &uuml;ber MySQL zu verf&uuml;gen.'/*/WP_I18N_OLD_MYSQL*/ );
...
if ( is_wp_error($prefix) )
	wp_die(/*WP_I18N_BAD_PREFIX*/'<strong>FEHLER</strong>: <code>$table_prefix</code> in  der Datei <code>wp-config.php</code> darf nur Nummern, Buchstaben und Unterstriche enthalten.'/*/WP_I18N_BAD_PREFIX*/);
