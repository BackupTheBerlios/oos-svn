...
?>
     <tr>
      ...
      <tr><?php echo oos_draw_form('new_product', $aFilename['products'], 'categories=' . $categories . '&pID=' . $_GET['pID'] . '&action=' . $form_action, 'post', 'enctype="multipart/form-data"'); ?>
...
?>
        <td class="main" align="right"><?php echo oos_draw_hidden_field('products_date_added', (($pInfo->products_date_added) ? $pInfo->products_date_added : date('Y-m-d'))) . oos_image_swap_submits('save', 'save_off.gif', IMAGE_SAVE) . '&nbsp;&nbsp;<a href="' . oos_href_link_admin($aFilename['categories'], 'categories=' . $categories . '&pID=' . $_GET['pID']) . '">' . oos_image_swap_button('cancel', 'cancel_off.gif', IMAGE_CANCEL) . '</a>'; ?></td>
<?php
    }
?>
      </form></tr>
