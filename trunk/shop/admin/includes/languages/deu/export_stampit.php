<?php
/* ----------------------------------------------------------------------
   $Id: export_stampit.php,v 1.1 2007/10/30 18:04:23 r23 Exp $
...
define('HEADING_TITLE', 'Adressen Export'); 
...
define('SUCCESS_DATABASE_SAVED', 'Erfolg: Die Adressen wurden gesichert.');
