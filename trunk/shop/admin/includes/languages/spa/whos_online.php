<?php
/* ----------------------------------------------------------------------
   $Id: whos_online.php,v 1.4 2006/01/24 17:53:08 r23 Exp $
   ...
   File: whos_online.php,v 1.5 2002/03/30 16:21:18 harley_vb 
   ----------------------------------------------------------------------
...
define('TEXT_NUMBER_OF_CUSTOMERS', 'Hay actualmente %s clientes en l�ea');
?>
