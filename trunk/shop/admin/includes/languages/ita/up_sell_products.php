<?php
/* ----------------------------------------------------------------------
   $Id: up_sell_products.php,v 1.4 2006/11/25 17:36:38 thesee Exp $
...
define('UP_SELL_SUCCESS', 'UP Sell Items Aggiornati con Successo per il prodotto UP Sell Product #'.$_GET['add_related_product_ID']);
define('SORT_UP_SELL_SUCCESS', 'Ordinamento Aggiornato con Successo per il prodotto UP Sell Product #'.$_GET['add_related_product_ID']);
...
define('TEXT_SETTING_SELLS', 'Definisci Vendita-Cosigliata per');
