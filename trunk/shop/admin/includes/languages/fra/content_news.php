<?php
/* ----------------------------------------------------------------------
   $Id: content_news.php,v 1.1 2005/10/14 15:04:01 r23 Exp $
...
define('TABLE_NEWS_CATEGORIES', 'Catégories:');
...
define('TEXT_DATE_EXPIRES', 'G&uuml;ltig bis:');
...
define('TEXT_NEWS_DATE_EXPIRES', 'Diese News sind g&uuml;ltig bis %s.');
...
define('ERROR_CATALOG_IMAGE_DIRECTORY_NOT_WRITEABLE', 'Fehler: Das Verzeichnis \'images\' im Katalogverzeichnis ist schreibgesch&uuml;tzt: ' . OOS_SHOP_PATH_IMAGES);
define('ERROR_CATALOG_IMAGE_DIRECTORY_DOES_NOT_EXIST', 'Fehler: Das Verzeichnis \'images\' im Katalogverzeichnis ist nicht vorhanden: ' . OOS_SHOP_PATH_IMAGES);
?>
