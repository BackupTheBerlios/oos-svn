<?php
/* ----------------------------------------------------------------------
   $Id: coupon_admin.php,v 1.1 2005/10/14 15:04:01 r23 Exp $
...
define('TEXT_TO_REDEEM', 'Sie k&ouml;nnen diesen Gutschein beim Beenden Ihrer Bestellung eingeben. Geben Sie einfach den Gutscheinkode im entsprechenden Eingabefeld ein und klicken Sie auf den Einl&ouml;sen-Knopf.');
define('TEXT_IN_CASE', ' im Falle dass Sie Probleme haben.');
define('TEXT_VOUCHER_IS', 'Der Gutscheinkode lautet ');
define('TEXT_REMEMBER', 'Bewahren Sie den Gutscheinkode gut auf, damit Sie von diesem speziellen Angebot profitieren k&ouml;nnen!');
...
define('ERROR_NO_CUSTOMER_SELECTED', 'Error: Sie haben keinen Kunden ausgew&auml;hlt!');
define('COUPON_NAME', 'Gutschein Name');
//define('COUPON_VALUE', 'Coupon Value');
define('COUPON_AMOUNT', 'Gutschein Wert');
define('COUPON_CODE', 'Gutscheinkode');
...
define('COUPON_AMOUNT_HELP', 'Geben Sie einen Gutscheinwert an. Entweder einen bestimmten Betrag oder ein Prozentzeichen (%) am Ende f&uuml;r einen prozentualen Nachlass.');
define('COUPON_CODE_HELP', 'Sie k&ouml;nnen hier einen Gutscheinkode eingeben, oder das Feld leer lassen. Es wird dann ein automatisch erzeugter Gutscheinkode verwendet.');
...
define('COUPON_FREE_SHIP_HELP', 'F&uuml;r diesen Gutschein kann der Kunde versandkostenfrei bestellen! Bitte beachten Sie: Diese Auswahl &uuml;berschreibt den Warenwert, ber&uuml;cksichtigt jedoch den Mindestbestellwert!');
