<?php
/* ----------------------------------------------------------------------
   $Id: ticket_view.php,v 1.1 2005/10/14 15:04:01 r23 Exp $
...
define('HEADING_TITLE_PRIORITY','Ticket Priorit&auml;t:');
...
define('TEXT_CUSTOMER_LOGIN_YES', 'Kunde muss eingeloggt sein um das Ticket zu sehen');
define('TEXT_CUSTOMER_LOGIN_NO', 'Kunde muss nicht eingeloggt sein um das Ticket zu sehen');
define('TEXT_COMMENT','Antwort:');
define('TEXT_DATE','Datum:');
define('TEXT_DATE_TICKET_CREATED','Ticket erstellt: ');
define('TEXT_DATE_TICKET_LAST_MODIFIED','letzte &Auml;nderung: '); 
...
define('TEXT_INSERT','Einf&uuml;gen');
...
define('TICKET_EMAIL_MESAGE_HEADER',"Ihre Anfrage wurde soeben bearbeitet..\nSie k&ouml;nnen Ihre Anfrage jederzeit unter folgenden Link einsehen:");
define('TICKET_EMAIL_MESAGE_FOOTER',"Sollten noch fragen offen sein benutzen Sie bitte unser Supportticketsystem\n\nBitte nicht auf diese Email antworten, sondern benutzen Sie das Supportticketsystem.");
