<?php
/* ----------------------------------------------------------------------
   $Id: gv_queue.php,v 1.1 2005/10/14 15:04:01 r23 Exp $
...
define('TEXT_REDEEM_COUPON_MESSAGE_HEADER', 'Sie haben erfolgreich einen Gutschein in unserem Shop erworben.' . "\n"
                                          . 'Aus Sicherheitsgr&uuml;nden wurde der Gutschein nicht sofort Ihrem Konto gutgeschrieben.' . "\n"
                                          . 'Der Gutschein wurde Ihrem Konto jetzt gutgeschrieben. Sie k&ouml;nnen nun unseren Shop besuchen' . "\n"
                                          . 'und den Gutschein an jeden beliebigen Empf&auml;nger versenden.' . "\n\n");
