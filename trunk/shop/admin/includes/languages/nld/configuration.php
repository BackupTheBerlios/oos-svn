<?php
/* ----------------------------------------------------------------------
   $Id: configuration.php,v 1.39 2008/08/14 11:46:50 r23 Exp $
...
define('MAKE_PASSWORD_TITLE', 'create Password');
define('MAKE_PASSWORD_DESC', 'OOS create the Password for login');
...
define('ACCOUNT_COMPANY_VAT_ID_CHECK_TITLE', 'VATChecker');
define('ACCOUNT_COMPANY_VAT_ID_CHECK_DESC', 'Verify VAT ID');
...
define('OOS_FCKEDITOR_DESC', 'WYSIWYG bij de gegevensverwerking gebruiken?');

define('NEW_PRODUCT_PREVIEW_TITLE', 'Show Product preview');
define('NEW_PRODUCT_PREVIEW_DESC', 'Product preview');

define('OOS_PRICE_IS_BRUTTO_TITLE', 'Price incl. Tax');
define('OOS_PRICE_IS_BRUTTO_DESC', 'Input Price incl. Tax');

define('OOS_BASE_PRICE_TITLE', 'Base-Price');
define('OOS_BASE_PRICE_DESC', 'Do you want to display the Base-Price?');

define('DECIMAL_CART_QUANTITY_TITLE', 'Decimal Cart - Quantity');
define('DECIMAL_CART_QUANTITY_DESC', 'Do you want to display the decimal Cart - Quantity?');
