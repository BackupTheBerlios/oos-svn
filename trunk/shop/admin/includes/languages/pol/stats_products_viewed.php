<?php
/* ----------------------------------------------------------------------
   $Id: stats_products_viewed.php,v 1.3 2006/01/24 17:52:42 r23 Exp $
...
define('HEADING_TITLE', 'Najcz�iej wywietlane produkty');

define('TABLE_HEADING_NUMBER', 'Nr');
define('TABLE_HEADING_PRODUCTS', 'Produkt');
define('TABLE_HEADING_VIEWED', 'Ilo�wywietle�);
