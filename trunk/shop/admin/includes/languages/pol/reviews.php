<?php
/* ----------------------------------------------------------------------
   $Id: reviews.php,v 1.3 2006/01/24 17:52:42 r23 Exp $
...
define('TEXT_INFO_PRODUCTS_AVERAGE_RATING', 'rednia ocen:');

define('TEXT_OF_5_STARS', '%s of 5 Gwiazdek!');
define('TEXT_GOOD', '<small><font color="#ff0000"><b>DOBRY</b></font></small>');
define('TEXT_BAD', '<small><font color="#ff0000"><b>ZY</b></font></small>');
define('TEXT_INFO_HEADING_DELETE_REVIEW', 'Usu�recenzj�);
?>
