<?php
/* ----------------------------------------------------------------------
   $Id: categories.php,v 1.164 2009/02/20 17:57:07 r23 Exp $
      ...
      default:
        if ($rows > 0) {
          if (isset($cInfo) && is_object($cInfo)) { // category info box contents
            ...
            $contents[] = array('align' => 'center', 'text' => '<a href="' . oos_href_link_admin($aFilename['products'], 'categories=' . $categories . '&pID=' . $pInfo->products_id . '&action=new_product') . '">' . oos_image_swap_button('edit', 'edit_off.gif', IMAGE_EDIT) . '</a> <a href="' . oos_href_link_admin($aFilename['categories'], 'categories=' . $categories . '&pID=' . $pInfo->products_id . '&action=delete_product') . '">' . oos_image_swap_button('delete', 'delete_off.gif', IMAGE_DELETE) . '</a> <a href="' . oos_href_link_admin($aFilename['categories'], 'categories=' . $categories . '&pID=' . $pInfo->products_id . '&action=move_product') . '">' . oos_image_swap_button('move', 'move_off.gif', IMAGE_MOVE) . '</a> <a href="' . oos_href_link_admin($aFilename['categories'], 'categories=' . $categories . '&pID=' . $pInfo->products_id . '&action=copy_to') . '">' . oos_image_swap_button('copy_to', 'copy_to_off.gif', IMAGE_COPY_TO) . '</a>');
