...
function oosDoUpgrade180 ($dbhost, $dbuname, $dbpass, $dbname, $prefix_table, $dbtype) {
    global $db, $currentlang, $update;
    include("oos180.php");
}
...
function print_SelectOOS() {
  ...
  echo '<font class="oos-title">' . OOSUPGRADE_1 . ':</font><br /><br />' . "\n" .
       ...
       '<input type="hidden" name="aupdate" value="oos180">' . "\n";
  echo '<table width="50%" align="center">' . "\n" .
         ' <tr>' . "\n" .
         '  <td><input type="submit"  name ="op" value="OOS 1.8.0"></td>' . "\n" .
         '</tr></table></form><br>' . "\n" .
         '<form name="oos updrade" action="update.php" method="post">' . "\n" .
