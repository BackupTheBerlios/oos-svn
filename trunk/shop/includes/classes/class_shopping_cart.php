<?php
/* ----------------------------------------------------------------------
   $Id: class_shopping_cart.php,v 1.42 2008/11/12 14:56:23 r23 Exp $
    ...
    function get_products() {
      ...
      while (list($products_id, ) = each($this->contents)) {
        ...
        $sql = "SELECT p.products_id, pd.products_name, p.products_image, p.products_model, p.products_ean,
                       p.products_price, p.products_discount_allowed, p.products_weight, p.products_tax_class_id, p.products_status
