 ...
 */
    ...
    function load_filter($type, $name)
    {
        ...
        switch ($type) {
            case 'output':
                ...
                MyOOS_CoreApi::requireOnce('lib/smarty/libs/internals/core.load_plugins.php');
    ...
    function clear_cache($tpl_file = null, $cache_id = null, $compile_id = null, $exp_time = null)
    {
        ...
        if (!empty($this->cache_handler_func)) {
            ...
            $_params = array('auto_base' => $this->cache_dir,
                            ...
                            'auto_id' => $_auto_id,
                            'exp_time' => $exp_time);
            MyOOS_CoreApi::requireOnce('lib/smarty/libs/internals/core.rm_auto.php');
    ...
    function is_cached($tpl_file, $cache_id = null, $compile_id = null)
    {
        ...
        MyOOS_CoreApi::requireOnce('lib/smarty/libs/internals/core.read_cache_file.php');
...
echo SMARTY_CORE_DIR;
    ...
    function fetch($resource_name, $cache_id = null, $compile_id = null, $display = false)
    {
        ...
        if ($this->caching) {
            ...
            if (smarty_core_read_cache_file($_params, $this)) {
                ...
                if (!empty($this->_cache_info['insert_tags'])) {
                    ...
                    MyOOS_CoreApi::requireOnce('lib/smarty/libs/internals/core.process_cached_inserts.php');
                    $_smarty_results = smarty_core_process_cached_inserts($_params, $this);
                }
                if (!empty($this->_cache_info['cache_serials'])) {
                    $_params = array('results' => $_smarty_results);
                    MyOOS_CoreApi::requireOnce('lib/smarty/libs/internals/core.process_compiled_include.php');
        ...
        if ($this->caching) {
            ...
            MyOOS_CoreApi::requireOnce('lib/smarty/libs/internals/core.write_cache_file.php');
    ...
    function _compile_resource($resource_name, $compile_path)
    {
        ...
        if ($this->_compile_source($resource_name, $_source_content, $_compiled_content, $_cache_include)) {
            ...
            if ($this->_cache_include_info) {
                MyOOS_CoreApi::requireOnce('lib/smarty/libs/internals/core.write_compiled_include.php');
                smarty_core_write_compiled_include(array_merge($this->_cache_include_info, array('compiled_content'=>$_compiled_content, 'resource_name'=>$resource_name)),  $this);
            }

            $_params = array('compile_path'=>$compile_path, 'compiled_content' => $_compiled_content);
            MyOOS_CoreApi::requireOnce('lib/smarty/libs/internals/core.write_compiled_resource.php');
   ...
   /**
    ...
    function _parse_resource_name(&$params)
    {
        ...
        if ($params['resource_type'] == 'file') {
            ...
            MyOOS_CoreApi::requireOnce('lib/smarty/libs/internals/core.load_resource_plugin.php');
