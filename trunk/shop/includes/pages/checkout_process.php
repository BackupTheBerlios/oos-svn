<?php
/* ----------------------------------------------------------------------
   $Id: process.php 290 2009-06-20 17:04:27Z r23 $
...
$oShippingModules = new shipping($_SESSION['shipping']);
...
$sql_data_array = array('customers_id' => $_SESSION['customer_id'],
                        ...
                        'cc_start' => $oOrder->info['cc_start'],
                        'cc_issue' => $oOrder->info['cc_issue'],
                        'cc_cvv' => $oOrder->info['cc_cvv'],
