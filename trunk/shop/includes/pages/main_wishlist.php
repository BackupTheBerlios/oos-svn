<?php
/* ----------------------------------------------------------------------
   $Id: wishlist.php 312 2009-07-21 14:59:24Z r23 $
...
// links breadcrumb
$oBreadcrumb->add($customer. $aLang['navbar_title'], oos_href_link($aModules['account'], $aFilename['main_wishlist']), bookmark);
