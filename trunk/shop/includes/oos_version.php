<?php
/* ----------------------------------------------------------------------
   $Id: oos_version.php,v 1.26 2007/06/15 09:25:14 r23 Exp $
  ...
  */
  define('OOS_VERSION_MAJOR', '2');

 /**
  * Minor software version
  */
  define('OOS_VERSION_MINOR', '1');

 /**
  * Micro software version
  */
  define('OOS_VERSION_MICRO', '0');

 /**
  * Software version patch
  */
  define('OOS_VERSION_PATCH', '-dev');
