<?php
/* ----------------------------------------------------------------------
   $Id: pol.php,v 1.1 2007/11/26 22:46:01 r23 Exp $
...
define('PLUGIN_EVENT_WISHLIST_NAME', 'Wunschzettel');
define('PLUGIN_EVENT_WISHLIST_DESC', 'Kunden k&ouml;nnen eine Wunschliste verwalten.');
