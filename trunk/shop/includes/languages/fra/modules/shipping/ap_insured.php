<?php
/* ----------------------------------------------------------------------
   $Id: ap_insured.php,v 1.11 2007/04/23 15:37:35 r23 Exp $
...
define('MODULE_SHIPPING_AP_INSURED_STATUS_DESC', 'Wollen Sie den Versand über die &Ouml;sterreichische Post AG anbieten?');
...
define('MODULE_SHIPPING_AP_INSURED_TAX_CLASS_DESC', 'W&auml;hlen Sie den MwSt.-Satz für diese Versandart aus.');
