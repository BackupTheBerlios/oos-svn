<?php
/* ----------------------------------------------------------------------
   $Id: weight.php,v 1.2 2006/05/08 01:01:25 r23 Exp $
...
define('MODULE_SHIPPING_WEIGHT_ZONE_DESC', 'Wenn Sie eine Zone auswählen, wird diese Versandart nur in dieser Zone angeboten.');
...
$aLang['module_shipping_weight_text_title'] = 'Gewichtsabhängige Versandkosten';
