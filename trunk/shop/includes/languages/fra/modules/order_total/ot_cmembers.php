<?php
/* ----------------------------------------------------------------------
   $Id: ot_cmembers.php,v 1.3 2006/05/08 01:01:24 r23 Exp $
...
$aLang['module_cmembers_title'] = 'Rabais client selon quantité';
$aLang['module_cmembers_description'] = 'Rabais client selon quantité';
$aLang['shipping_not_included'] = ' [Les frais d\'expéditions ne sont pas inclues]';
$aLang['tax_not_included'] = ' [La T.V.A n\’est pas inclue]';
?>