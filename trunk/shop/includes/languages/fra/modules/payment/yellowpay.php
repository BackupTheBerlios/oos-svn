<?php
/* ----------------------------------------------------------------------
   $Id: yellowpay.php,v 1.2 2006/05/08 01:01:25 r23 Exp $
...
define('MODULE_PAYMENT_YELLOWPAY_SHOP_ID_TITLE', 'Shop ID (Von der Post erhalten)');
define('MODULE_PAYMENT_YELLOWPAY_SHOP_ID_DESC', 'Shop ID (Von der Post erhalten)');
...
define('MODULE_PAYMENT_YELLOWPAY_ZONE_TITLE', 'Zone');
define('MODULE_PAYMENT_YELLOWPAY_ZONE_DESC', 'W&auml;hlen Sie f&uuml;r welche Zone dieses Modul aktiviert werden soll.');
