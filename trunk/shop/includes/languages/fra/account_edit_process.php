<?php
/* ----------------------------------------------------------------------
   $Id: account_edit_process.php,v 1.1 2005/10/14 17:32:37 r23 Exp $
...
$aLang['navbar_title_2'] = 'Modifier vos données personnelles';
$aLang['heading_title'] = 'Modifier vos données personnelles:';

$aLang['OWNER_EMAIL_SUBJECT'] = 'Nouvelles données de client';
$aLang['OWNER_EMAIL_DATE'] = 'Date:';
$aLang['OWNER_EMAIL_COMPANY_INFO'] = 'Données díentreprise';
$aLang['OWNER_EMAIL_CONTACT'] = 'Informations de contact';
...
$aLang['OWNER_EMAIL_POST_CODE'] = 'Code postal:';
...
$aLang['OWNER_EMAIL_NEWSLETTER_NO'] = 'ne pas abonné';
