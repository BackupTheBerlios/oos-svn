<?php
/* ----------------------------------------------------------------------
   $Id: admin_login.php,v 1.2 2005/11/07 16:11:26 r23 Exp $
...
$aLang['entry_key'] = 'Clé sécuritaire'; // should be empty

$aLang['heading_admin_login'] = 'Inscrire à un compte client';
