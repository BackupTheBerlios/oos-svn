<?php
/* ----------------------------------------------------------------------
   $Id: cod.php,v 1.5 2006/08/27 00:46:39 r23 Exp $
...
$aLang['module_payment_cod_text_title'] = 'Наличными после доставки';
$aLang['module_payment_cod_text_description'] = 'Наличными после доставки';
