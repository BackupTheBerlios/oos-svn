...
$aLang['text_see_orders'] = 'Вы можете просмотреть историю заказов перейдя к странице <a href="' . oos_href_link($aPages['account'], '', 'SSL') . '">\'Мой Профиль\'</a> и далее к странице <a href="' . oos_href_link($aModules['account'], $aFilename['account_history'], '', 'SSL') . '">\'История Заказов\'</a>.';
$aLang['text_contact_store_owner'] = 'Вы можете задать любые вопросы напрямую <a href="' . oos_href_link($aPages['contact_us']) . '">владельцу магазина</a>.';
