<?php
/* ----------------------------------------------------------------------
   $Id: account_edit_process.php,v 1.3 2006/01/24 17:53:52 r23 Exp $
...
$aLang['navbar_title_2'] = 'Uw persoonlijke gegevens veranderen';
$aLang['heading_title'] = 'Uw persoonlijke gegevens veranderen:';

$aLang['OWNER_EMAIL_SUBJECT'] = 'Nieuwe klantgegevens';
$aLang['OWNER_EMAIL_DATE'] = 'Datum:';
$aLang['OWNER_EMAIL_COMPANY_INFO'] = 'Bedrijsgegevens';
$aLang['OWNER_EMAIL_CONTACT'] = 'Contactinformatie';
$aLang['OWNER_EMAIL_OPTIONS'] = 'Opties';
$aLang['OWNER_EMAIL_COMPANY'] = 'Bedrijsnaam:';
$aLang['OWNER_EMAIL_OWNER'] = 'Eigenaar:';
$aLang['OWNER_EMAIL_NUMBER'] = 'Klantnummer:';
$aLang['OWNER_EMAIL_GENDER'] = 'Aanspreektitel:';
$aLang['OWNER_EMAIL_FIRST_NAME'] = 'Voonaam:';
