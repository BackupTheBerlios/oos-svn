<?php
/* ----------------------------------------------------------------------
   $Id: ot_cod_fee.php,v 1.9 2007/10/26 23:06:00 r23 Exp $
...
define('MODULE_ORDER_TOTAL_COD_FEE_AP_DESC', '&Ouml;stereichische Post:&lt;Landcode&gt;:&lt;Verzendkosten&gt;, .... 00 als landcode geldt voor alle landen. Als de landcode 00 is, dan moet dit de laatste invoer zijn. Als geen 00:9.99 verschijnt, dan worden de verzendkosten naar het buitenland niet berekend (niet mogelijk)');

define('MODULE_ORDER_TOTAL_COD_FEE_CHP_TITLE', 'The Swiss Post');
define('MODULE_ORDER_TOTAL_COD_FEE_CHP_DESC', 'Swiss Post: &lt;Landcode&gt;:&lt;Verzendkosten&gt;, .... 00 als landcode geldt voor alle landen. Als de landcode 00 is, dan moet dit de laatste invoer zijn. Als geen 00:9.99 verschijnt, dan worden de verzendkosten naar het buitenland niet berekend (niet mogelijk)');

define('MODULE_ORDER_TOTAL_COD_FEE_HERMES_TITLE', 'Hermes Versand');
define('MODULE_ORDER_TOTAL_COD_FEE_HERMES_DESC', 'Hermes Versand: &lt;Landcode&gt;:&lt;Verzendkosten&gt;, .... 00 als landcode geldt voor alle landen. Als de landcode 00 is, dan moet dit de laatste invoer zijn. Als geen 00:9.99 verschijnt, dan worden de verzendkosten naar het buitenland niet berekend (niet mogelijk)');

define('MODULE_ORDER_TOTAL_COD_FEE_DP_TITLE', 'Verzendkosten voor Deutsche Post');
define('MODULE_ORDER_TOTAL_COD_FEE_DP_DESC',  'Deutsche Post: &lt;Landcode&gt;:&lt;COD price&gt;, .... 00 als landcode geldt voor alle landen. Als de landcode 00 is, dan moet dit de laatste invoer zijn. Als geen 00:9.99 verschijnt, dan worden de verzendkosten naar het buitenland niet berekend (niet mogelijk)');
