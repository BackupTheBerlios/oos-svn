<?php
/* ----------------------------------------------------------------------
   $Id: ap.php,v 1.7 2008/08/05 20:19:54 r23 Exp $
...
define('MODULE_SHIPPING_AP_STATUS_DESC', 'Wollen Sie den Versand über die &Ouml;sterreichische Post AG anbieten?');
...
define('MODULE_SHIPPING_AP_TAX_CLASS_DESC', 'W&auml;hlen Sie den MwSt.-Satz für diese Versandart aus.');
