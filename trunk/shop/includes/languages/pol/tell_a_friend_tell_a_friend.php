<?php
/* ----------------------------------------------------------------------
   $Id: tell_a_friend_tell_a_friend.php,v 1.3 2006/01/24 17:54:07 r23 Exp $
...
$aLang['text_email_link'] = 'Um das Produkt anzusehen, klicken Sie bitte auf den Link oder kopieren diesen und fgen Sie ihn in der Adress-Zeile Ihres Browsers ein:' . "\n\n" . '%s';
$aLang['text_email_signature'] = 'Mit freundlichen Grssen,' . "\n\n" . '%s';
?>
