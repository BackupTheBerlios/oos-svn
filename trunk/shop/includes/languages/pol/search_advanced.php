<?php
/* ----------------------------------------------------------------------
   $Id: search_advanced.php,v 1.3 2006/01/24 17:54:07 r23 Exp $
...
$aLang['js_at_least_one_input'] = '* Eines der folgenden Felder muss ausgefllt werden:\n    Stichworte\n    Datum hinzugefgt von\n    Datum hinzugefgt bis\n    Preis ab\n    Preis bis\n';
$aLang['js_invalid_from_date'] = '* Unzul�siges von Datum\n';
$aLang['js_invalid_to_date'] = '* Unzul�siges bis jetzt\n';
$aLang['js_to_date_less_than_from_date'] = '* Das Datum von muss gr�ser oder gleich bis jetzt sein\n';
$aLang['js_price_from_must_be_num'] = '* Preis ab, muss eine Zahl sein\n';
$aLang['js_price_to_must_be_num'] = '* Preis bis, muss eine Zahl sein\n';
$aLang['js_price_to_less_than_price_from'] = '* Preis bis muss gr�er oder gleich Preis ab sein.\n';
$aLang['js_invalid_keywords'] = '* Suchbegriff unzul�sig\n';
?>
