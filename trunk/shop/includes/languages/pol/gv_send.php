<?php
/* ----------------------------------------------------------------------
   $Id: gv_send.php,v 1.4 2007/05/07 09:16:12 r23 Exp $
...
$aLang['error_entry_amount_check'] = '&nbsp;&nbsp;<span class="errorText">Ungltiger Betrag</span>';
$aLang['error_entry_email_address_check'] = '&nbsp;&nbsp;<span class="errorText">Ungltige Email-Adresse</span>';
...
$aLang['text_success'] = 'Glckwunsch, Ihr Gutschein wurde erfolgreich verschickt.';

$aLang['email_separator'] = '----------------------------------------------------------------------------------------';
$aLang['email_gv_text_header'] = 'Herzlichen Glckwunsch, Sie haben einen Gutschein im Wert von %s';
