<?php
/* ----------------------------------------------------------------------
   $Id: certifiedmail.php,v 1.3 2008/08/27 12:36:14 r23 Exp $
...
// class methods
    ...
    function install() {
      ...
      $dbconn->Execute("INSERT INTO $configurationtable (configuration_key, configuration_value, configuration_group_id, sort_order, date_added) VALUES ('MODULE_SHIPPING_CERTIFIED_MAIL_SORT_ORDER', '0', '6', '0', now())");
    }
