           ...
           switch ($products_options_name['products_options_type']) {
                ...
                case PRODUCTS_OPTIONS_TYPE_RADIO:
                  ...
                  while ($products_options_array = $products_options_result->fields)
                  {
                      ...
                      $options .= oos_draw_radio_field('id[' . $products_options_name['products_options_id'] . ']', $products_options_array['products_options_values_id'], $bChecked);
                ...
                case PRODUCTS_OPTIONS_TYPE_CHECKBOX:
                  ...
                  $options .= oos_draw_checkbox_field('id[' . $products_options_name['products_options_id'] . ']', $products_attribs_array['products_options_values_id'], $bChecked);
