...
/* ----------------------------------------------------------------------
  ...
  class ot_coupon {
    ...
    function ot_coupon() {
      ...
      $this->user_prompt = '';
      $this->enabled = (defined('MODULE_ORDER_TOTAL_COUPON_STATUS') && (MODULE_ORDER_TOTAL_COUPON_STATUS == '1') ? true : false);
...
// attributes price
    ...
    if ($this->include_shipping == '1') $total_price += $oOrder->info['shipping_cost'];
    return $total_price;
}
    ...
    function install() {
      ...
      $dbconn->Execute("INSERT INTO $configurationtable (configuration_key, configuration_value, configuration_group_id, sort_order, set_function, date_added) VALUES ('MODULE_ORDER_TOTAL_COUPON_STATUS', '1', '6', '1','oos_cfg_select_option(array(\'1\', \'0\'), ', now())");
      ...
      $dbconn->Execute("INSERT INTO $configurationtable (configuration_key, configuration_value, configuration_group_id, sort_order, set_function ,date_added) VALUES ('MODULE_ORDER_TOTAL_COUPON_INC_SHIPPING', '1', '6', '5', 'oos_cfg_select_option(array(\'1\', \'0\'), ', now())");
      $dbconn->Execute("INSERT INTO $configurationtable (configuration_key, configuration_value, configuration_group_id, sort_order, set_function ,date_added) VALUES ('MODULE_ORDER_TOTAL_COUPON_INC_TAX', '1', '6', '6','oos_cfg_select_option(array(\'1\', \'0\'), ', now())");
