...
/* ----------------------------------------------------------------------
  ...
  class ot_xmembers {
    ...
    function ot_xmembers() {
      ...
      $this->enabled = (defined('MODULE_XMEMBERS_STATUS') && (MODULE_XMEMBERS_STATUS == '1') ? true : false);
  ...
  function get_order_total() {
    ...
    function install() {
      ...
      $dbconn->Execute("INSERT INTO  $configurationtable (configuration_key, configuration_value, configuration_group_id, sort_order, set_function, date_added) values ('MODULE_XMEMBERS_STATUS', '1', '6', '1','oos_cfg_select_option(array(\'1\', \'0\'), ', now())");
      ...
      $dbconn->Execute("INSERT INTO  $configurationtable (configuration_key, configuration_value, configuration_group_id, sort_order, set_function ,date_added) values ('MODULE_XMEMBERS_INC_SHIPPING', '1', '6', '5', 'oos_cfg_select_option(array(\'1\', \'0\'), ', now())");
      $dbconn->Execute("INSERT INTO  $configurationtable (configuration_key, configuration_value, configuration_group_id, sort_order, set_function ,date_added) values ('MODULE_XMEMBERS_INC_TAX', '1', '6', '6','oos_cfg_select_option(array(\'1\', \'0\'), ', now())");
      $dbconn->Execute("INSERT INTO  $configurationtable (configuration_key, configuration_value, configuration_group_id, sort_order, set_function ,date_added) values ('MODULE_XMEMBERS_CALC_TAX', '0', '6', '5','oos_cfg_select_option(array(\'1\', \'0\'), ', now())");
    }
